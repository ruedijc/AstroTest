...
public class JulianDate {
    ...
    /*
     * Based on Ch7 of Jean Meesus
     */
    public static Double getJulianDay(Calendar cal) {
        // step 1
        int year = cal.get(Calendar.YEAR);
        int month = cal.get(Calendar.MONTH) + 1;    // fix the January=0
        double day = cal.get(Calendar.DAY_OF_MONTH);
        double hour = cal.get(Calendar.HOUR_OF_DAY) / 24.0;
        double minute = cal.get(Calendar.MINUTE) / 24.0 / 60.0;
        double second = cal.get(Calendar.SECOND) / 24.0 / 60.0 / 60.0;
        ...
        // step 6
        double jd = Math.floor(365.25 * year)
        		+ Math.floor(30.6001 * ++month)
        		- 15
        		+ 1720996.5
        		+ day
        		+ hour + minute + second;
        
  	   if(DEBUG) Log.d("JD","Hour: " + cal.get(Calendar.HOUR_OF_DAY) + ", minute: " + cal.get(Calendar.MINUTE));

 	   if(DEBUG) Log.d("JD","Julian Day is: " +jd);
